		...
		<div class="site-wrapper-inner">
			...
			<div class="cover-container">
				...
				<div class="inner cover">
					...
					%>
						no tiene acceso al servicio.<br> Contacte con el
						ADMINISTRADOR para mas información. <br>"<%=errorCodigo%>"
					</p>
					<p class="lead">
						<a href="/user/logout" class="btn btn-lg btn-default">Otra Cuenta</a>
					</p>
