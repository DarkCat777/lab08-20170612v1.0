...
<script>
        function verificarUrl() {
            ...
            if (!rpta) {
                alert("Introduzca una expresión correcta /*/*");
                return false;
            }else{
				...
				<div class="inner cover">
					...
					<div id="contenido">
						...
						<div class="formulario">
							<form action="/resource/add" method="post" onsubmit="return verificarUrl()">
								<label><b>Dirección (URL): </b></label> <br> <input
									type="text" name="url" id="url" placeholder="URL: /***/***" required>
								<br> <br> <label><b>Estado:</b></label> <br> <select
									name="status">
									<option value="true">Activo</option>
									<option value="false">Desactivado</option>
								</select> <br> <br> <input class="boton" name="boton" type="submit"
									value="Añadir Recurso">
							</form>
						</div>
						<div class=link>
