						...
						<div class="formulario">
							<form action="/role/add" method="post">
								<label><b>Nombre del Role: </b></label> <br> <input
									type="text" name="name" placeholder="Nombre del Role" required>
								<br> <br> <label><b>Fecha de Creación:</b></label> <br>
								<input type="date" name="create" required> <br>
								<br> <label><b>Estado:</b></label> <br> <select
									name="status">
									<option value="true">Activo</option>
									<option value="false">Desactivado</option>
								</select> <br> <br> <input class="boton"
									type="submit" value="Añadir Role">
							</form>
						</div>
						<div class=link>
							<a href="/role" class="link" title="Añadir Role"><b>Lista de Roles</b></a>
						</div>
					</div>
				</div>
